...
mobileChecker = Ember.Object.extend
...
initializer = Ember.Object.create {
  ...
  initialize: (container, application) ->
    ...
    container.injection('route', 'mobileChecker', 'mobile-checker:main')
    # container.injection('controller', 'mobile-checker', 'mobile-checker:main')
    # container.injection('component', 'mobile-checker', 'mobile-checker:main')
    # container.injection('model', 'mobile-checker', 'mobile-checker:main')
    container.injection('view', 'mobileChecker', 'mobile-checker:main')
}
